<?php
    ...
    if($Operacion=="Insertar"){
        ...
        $user=array('Id' => $row[0],'Usuario' => $row[1], 'Nombre' => $row[3],'Puesto' => $row[4],'Telefono' => $row[5],'Correo'=>$row[6],'Estado'=>$row[7]);
        ...
        $puesto=$_POST['puesto'];
        $estado=$_POST['estado'];
        $consulta = "UPDATE usuario SET Usuario='$Usuario',Nombre='$Nombre',
